...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5393360,
    DYNAMIC_BASE = 5393360,
    DYNAMICTOP_PTR = 150224;
...
var ASM_CONSTS = [function() { window.prompt("inputHandler() called") },
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=150272;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  function _glBindFragDataLocation() {
  err('missing function: glBindFragDataLocation'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "_glBindFragDataLocation": _glBindFragDataLocation,
