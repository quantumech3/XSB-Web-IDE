...
var ASM_CONSTS = [function() { window._EmscriptenConsolePaused = true; window._EmscriptenConsoleGetInput(); },
 function() { return window._EmscriptenConsolePaused; }];
...
var eb = getMemory(392);
assert(eb % 8 === 0);
__ATPRERUN__.push(function() {
  HEAPU8.set([140,2,51,0,0,0,0,0,2,46,0,0,74,1,0,0,2,47,0,0,255,1,0,0,2,48,0,0,124,78,0,0,1,44,0,0,136,49,0,0,0,45,49,0,136,49,0,0,25,49,49,96,137,49,0,0,130,49,0,0,136,50,0,0,49,49,49,50,84,0,0,0,1,50,96,0,135,49,0,0,50,0,0,0,0,13,45,0,1,8,0,0,0,9,0,0,0,10,1,0,1,11,0,0,0,14,11,0,38,49,14,1,0,15,49,0,40,49,15,1,0,16,49,0,120,16,2,0,119,0,63,0,1,49,80,46,135,17,1,0,48,49,0,0,0,6,17,0,1,7,74,1,0,18,6,0,0,19,7,0,19,50,19,47,135,49,2,0,50,18,0,0,0,5,13,0,0,20,5,0,0,4,20,0,0,21,4,0,0,3,21,0,0,22,3,0,1,49,0,0,85,22,49,0,1,50,0,0,109,22,4,50,1,49,0,0,109,22,8,49,0,2,21,0,0,24,2,0,0,43,24,0,0,40,20,0,0,25,40,0,0,39,25,0,0,26,39,0,0,34,26,0,0,27,34,0,0,41,27,0,1,42,0,0,0,28,42,0,35,29,28,3,120,29,2,0,119,0,11,0,0,30,41,0,0,31,42,0,41,49,31,2,3,32,30,49,1,49,0,0,85,32,49,0,0,33,42,0,25,35,33,1,0,42,35,0,119,0,243,255,1,50,148,83,135,49,3,0,50,13,0,0,135,36,4,0,48,13,0,0,0,12,36,0,1,23,74,1,0,37,12,0,0,38,23,0,19,50,38,47,135,49,2,0,50,37,0,0,135,49,5,0,13,0,0,0,119,0,188,255,137,45,0,0,1,49,0,0,139,49,0,0], eb + 0);

  var relocations = [];
  relocations = relocations.concat([68]);

  for (var i = 0; i < relocations.length; i++) {
    assert(relocations[i] % 4 === 0);
    assert(relocations[i] >= 0 && relocations[i] < eb + 392); // in range
  ...
  var _stderr=22480;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
