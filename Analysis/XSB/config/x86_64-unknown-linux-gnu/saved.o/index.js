...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 7854272,
    DYNAMIC_BASE = 7854272,
    DYNAMICTOP_PTR = 2611136;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=2611184;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  function _extend_enc_dec_as_nec() {
  err('missing function: extend_enc_dec_as_nec'); abort(-1);
  }
  ...
  var ___tm_current=2611232;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 2611280, 4), 2611280);function _gmtime_r(time, tmPtr) {
...
var asmLibraryArg = {
  ...
  "_execvp": _execvp,
  "_exit": _exit,
  "_extend_enc_dec_as_nec": _extend_enc_dec_as_nec,
  "_fork": _fork,
  "_ftime": _ftime,
  "_getenv": _getenv,
  ...
  "_putenv": _putenv,
  "_sched_get_priority_max": _sched_get_priority_max,
