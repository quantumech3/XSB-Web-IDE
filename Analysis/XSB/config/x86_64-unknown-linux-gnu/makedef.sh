...
SRCDIR=/home/quantumech/Desktop/XSB-Web-IDE/Analysis/XSB
CONFIGURATION=x86_64-unknown-linux-gnu
CONFIG_TAG=
SRC_CONFIG_PREFIX=/home/quantumech/Desktop/XSB-Web-IDE/Analysis/XSB/config/x86_64-unknown-linux-gnu
OBJS=$@
DEFFILE=out.def
TMPFILE=out.def.tmp
